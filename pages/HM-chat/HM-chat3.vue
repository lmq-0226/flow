		...
		<view class="input-box" :class="popupLayerClass" @touchmove.stop.prevent="discard">
			...
			<view class="textbox">
				...
				<view class="text-mode"  :class="isVoice?'hidden':''">
					<view class="box">
						<!-- <u-input v-model="value" auto-height="true" v-model="textMsg" @focus="textareaFocus"/> -->
					</view>
	...
	export default {
		...
		methods:{
			...
			replaceEmoji(str){
				...
				// display: flex;align-items: center;word-wrap:break-word;
				return '<div style="">'+replacedStr+'</div>';
			},
