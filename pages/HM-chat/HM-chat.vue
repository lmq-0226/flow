					...
					<block v-if="row.type=='user'">
						...
						<view class="my" v-if="row.msg.userinfo.uid==myuid">
							...
							<view class="left">
								...
								<!-- 图片消息 -->
								<view v-if="row.msg.type=='img'" class="bubble img" @tap.stop="showPic(row.msg)">
		...
		<view class="input-box" :class="popupLayerClass">
			...
			<view class="textbox">
				...
				<view class="text-mode" :class="isVoice ? 'hidden' : ''">
					<view class="box">
						<u-input  v-model="textMsg" type="textarea" :clearable="false" maxlength="-1" :auto-height="true" />
					</view>
					...
					for (let i = 0; i < this.emojiList.length; i++) {
						...
						for (let j = 0; j < row.length; j++) {
							...
							if (EM.alt == item) {
								...
								let imgstr = '<img width="17px" height="17px" src="' + onlinePath + this.onlineEmoji[EM.url] + '">';
