		...
		<view class="u-index-bar">
			...
			<view v-if="showSidebar" class="u-index-bar__sidebar" @touchstart.stop.prevent="onTouchMove"
				...
				<view v-for="(item, index) in indexList" :key="index" class="u-index-bar__index"
					:style="{zIndex: zIndex + 1, color: activeAnchorIndex === index && showIndex > -1 ? activeColor : ''}"
					:data-index="index">
					{{ item }}
					<view class="u-indexed-list-alert" v-if="activeAnchorIndex === index && showIndex > 99" :style="{ zIndex: showIndex }">
						<text>{{actived}}</text>
					</view>
				</view>
			</view>
